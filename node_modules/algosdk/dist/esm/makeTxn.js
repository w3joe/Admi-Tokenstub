 ...
 */
export function makeApplicationCallTxnFromObject({ sender, appIndex, onComplete, appArgs, accounts, foreignApps, foreignAssets, boxes, approvalProgram, clearProgram, numLocalInts, numLocalByteSlices, numGlobalInts, numGlobalByteSlices, extraPages, note, lease, rekeyTo, suggestedParams, }) {
    if (onComplete == null) {
 ...
 */
export function makeApplicationCreateTxnFromObject({ sender, onComplete, appArgs, accounts, foreignApps, foreignAssets, boxes, approvalProgram, clearProgram, numLocalInts, numLocalByteSlices, numGlobalInts, numGlobalByteSlices, extraPages, note, lease, rekeyTo, suggestedParams, }) {
 ...
 */
export function makeApplicationUpdateTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, approvalProgram, clearProgram, note, lease, rekeyTo, suggestedParams, }) {
    if (!appIndex) {
 ...
 */
export function makeApplicationDeleteTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, note, lease, rekeyTo, suggestedParams, }) {
    if (!appIndex) {
        throw Error('appIndex must be provided');
    }
    return makeApplicationCallTxnFromObject({
 ...
 */
export function makeApplicationOptInTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, note, lease, rekeyTo, suggestedParams, }) {
    if (!appIndex) {
        throw Error('appIndex must be provided');
    }
    return makeApplicationCallTxnFromObject({
 ...
 */
export function makeApplicationCloseOutTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, note, lease, rekeyTo, suggestedParams, }) {
    if (!appIndex) {
        throw Error('appIndex must be provided');
    }
    return makeApplicationCallTxnFromObject({
 ...
 */
export function makeApplicationClearStateTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, note, lease, rekeyTo, suggestedParams, }) {
    if (!appIndex) {
        throw Error('appIndex must be provided');
    }
    return makeApplicationCallTxnFromObject({
 ...
 */
export function makeApplicationNoOpTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, note, lease, rekeyTo, suggestedParams, }) {
    if (!appIndex) {
        throw Error('appIndex must be provided');
    }
    return makeApplicationCallTxnFromObject({
