...
import { generateModes } from './client/generator-context.mjs';
...
function cli(workingDirectory, args) {
    ...
    program
        ...
        .addOption(new Option('-m --mode <mode>', "Generate client in specified mode. The 'full' mode includes all features, 'minimal' generates a smaller client without deployment features.")
